...
# --- DASHBOARD BLINDADO (AQUÍ SE INYECTÓ TU MEJORA) ---
    ...
    try:
        ...
        if res_r.data:
            for item in res_r.data:
                ...
                # 🔄 MEJORA: Si la tabla de historial está vacía, muestra un mensaje amigable en lugar de N/A
                ultimo_precio = "🔄 Esperando Guardia..."
                try:
