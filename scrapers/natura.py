...
def consultar_natura_con_cascada(url_destino):
    ...
    try:
        ...
        if resp.status_code == 200 and len(resp.text) > 2000 and any(x in resp.text.lower() for x in ['product', 'natura', 'precio']):
    ...
    try:
        ...
        payload = {
            ...
            'url': url_destino,
            'country_code': 'us',
            'render': 'false'  # Mantiene el costo en 1 crédito por llamada
        }
