        ...
        if resp.status_code == 200:
            ...
            for t in items:
                try:
                    ...
                    if not tit_el: continue
                    o_el = t.select_one('span[id^="testId-pod-salePrice-"]') or t.select_one('.pod-saleprice') or t.select_one('span[class*="salePrice"]') or t.select_one('div[class*="rebrand-price"]')
