...
def revisar_ofertas():
    try:
        ...
        for item in res.data:
            ...
            if prods:
                # ✅ REPARACIÓN TOTAL DEL BUCLE PARA PERFUMES
                for p in prods:
                    if p['precio'] <= limite:
                        
                        # Si es un catálogo de perfumes, generamos un identificador único dinámico para evitar bloqueos
                        ...
                        # 2. Armar y enviar Alerta a Telegram
