...
def motor_juntoz(url, limite, headers=None):
    ...
    # Helper local de saneamiento de precio para evitar NameError de funciones externas
    ...
    if not headers:
        headers = {
            "User-Agent": random.choice(LISTA_USER_AGENTS) if 'LISTA_USER_AGENTS' in globals() else "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36",
    ...
    try:
        ...
        # =========================================================================
        # ⚡ ESTRATEGIA 1: BÚSQUEDA GRATUITA EN MICRODATOS JSON-LD (Ultra Preciso)
        # =========================================================================
        ...
        # =========================================================================
        # 🔍 ESTRATEGIA 2: TU BARRIDO DE DOM (FALLBACK SI NO HAY JSON-LD)
        # =========================================================================
        if not productos_map:
            enlaces_productos = []
            ...
            for a_el in enlaces_productos:
                try:
                    ...
                    # Corregido: uso de la función local limpiar_num_juntoz
